...
public class HttpsApiClient短信发送 extends ApacheHttpClient{
    public final static String HOST = "edisim.market.alicloudapi.com";
    static HttpsApiClient短信发送 instance = new HttpsApiClient短信发送();
    public static HttpsApiClient短信发送 getInstance(){return instance;}
